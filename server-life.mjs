...
const {directCharacterActivity,runIsolatedWorld}=await import('./state.js?v=20260907dev268');
const {buildSharedWorld}=await import('./shared-world.js?v=20260907dev268');
const {eventFor,withSimulationBatch}=await import('./simulation.js?v=20260907dev268');
