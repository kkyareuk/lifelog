...
const {directCharacterActivity,runIsolatedWorld}=await import('./state.js?v=20260909dev304');
const {buildSharedWorld}=await import('./shared-world.js?v=20260909dev304');
const {eventFor,withSimulationBatch}=await import('./simulation.js?v=20260909dev304');
