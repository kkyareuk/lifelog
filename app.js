...
import {recoverableBuildings,restoreBuildings} from "./state.js?v=20260906dev239";
import {groupErrorMessage} from "./groups.js?v=20260906dev239";
...
import("./auth.js?v=20260906dev239").catch(error=>{
