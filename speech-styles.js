...
function rawCharacterQuestionPrompt(character,{kind="everyday",target="",language="ko",base=""}={}){
  ...
  const lines={
    ...
    "스타트업 업무체":`${subject} 액션 아이템, 어떤 안으로 얼라인하면 될까요?`,
    ...
    "인터넷소설 감성체":`${subject} 머할까아…? 나 진짜 못 고르겠눈뎅 ㅠ_ㅠ`,
...
const CONTACT_TITLES={
  ko:{
    "반말":"잠깐 얘기할래?","했다체 · 건조한 서술":"전언이 도착했다","존댓말 · 해요체":null,"격식 있는 존댓말 · 하십시오체":"전해 드릴 말씀이 있습니다","극존칭":"삼가 말씀을 올리옵니다","무뚝뚝한 단답":"할 말.","기계적인 말투":"상태 메시지 수신","사무적인 말투 · 직장 메일체":"간단 공유드립니다","스타트업 업무체":"빠른 체크인","다정하고 부드러운 말투":"조용히 전하고 싶은 말","상냥하고 배려하는 말투":"천천히 읽어도 괜찮아요","소심하고 머뭇거리는 말투":"저기… 잠깐 괜찮을까요?","열정적인 말투":"지금 꼭 전하고 싶어요!","능글맞고 여유로운 말투":"뭐, 잠깐 들어 봐","냉소적인 말투":"별수 없이 전하는 말","걸걸한 아저씨 말투":"어이, 잠깐 보자고","거칠고 상스러운 말투":"야, 잠깐 들어 봐","중2병 말투":"봉인 너머의 전언","인터넷소설 감성체":"갑자기 니 생각나쏘…","하드보일드 누아르체":"도시에 남은 짧은 전언","고풍스러운 말투":"그대에게 띄우는 말","사극 선비 말투":"그대에게 청할 말이 있소","군인식 말투":"연락 사항 보고","마왕의 말투":"필멸자에게 내리는 전언","군주의 말투":"그대에게 고하는 말","신탁을 내리는 신의 말투":"오늘의 신탁","옛날 번역기체":"연락의 메시지가 도착했습니다","귀엽고 애교 있는 말투":"나한테 잠깐만 와 주라아","수다스럽고 말이 많은 말투":"별일은 아니고 잠깐 할 말이 있어요"
  },
  en:{
    "반말":"Hey, got a minute?","했다체 · 건조한 서술":"A message arrived","존댓말 · 해요체":null,"격식 있는 존댓말 · 하십시오체":"A message for your attention","극존칭":"A humble message","무뚝뚝한 단답":"Listen.","기계적인 말투":"STATUS MESSAGE","사무적인 말투 · 직장 메일체":"Quick update","스타트업 업무체":"Quick check-in","다정하고 부드러운 말투":"A gentle note","상냥하고 배려하는 말투":"Read this when you're ready","소심하고 머뭇거리는 말투":"Um… may I say something?","열정적인 말투":"I have to tell you this!","능글맞고 여유로운 말투":"Well, hear me out","냉소적인 말투":"A message, for what it's worth","걸걸한 아저씨 말투":"Hey, listen up","거칠고 상스러운 말투":"Hey. Listen.","중2병 말투":"A message beyond the seal","인터넷소설 감성체":"i suddenly thought of u…","하드보일드 누아르체":"A note left in the city","고풍스러운 말투":"A letter for thee","사극 선비 말투":"A word for you","군인식 말투":"CONTACT REPORT","마왕의 말투":"A decree for the mortal","군주의 말투":"A royal message","신탁을 내리는 신의 말투":"Today's oracle","옛날 번역기체":"The contact message has arrived","귀엽고 애교 있는 말투":"Come talk to meee","수다스럽고 말이 많은 말투":"It's nothing urgent, but I wanted to talk"
  },
  ja:{
    "반말":"ちょっと話さない？","했다체 · 건조한 서술":"伝言が届いた","존댓말 · 해요체":null,"격식 있는 존댓말 · 하십시오체":"お伝えしたいことがあります","극존칭":"謹んで申し上げます","무뚝뚝한 단답":"話がある。","기계적인 말투":"状態メッセージ受信","사무적인 말투 · 직장 메일체":"簡単に共有いたします","스타트업 업무체":"クイックチェックイン","다정하고 부드러운 말투":"そっと伝えたいこと","상냥하고 배려하는 말투":"ゆっくり読んでください","소심하고 머뭇거리는 말투":"あの……少しいいですか？","열정적인 말투":"今すぐ伝えたい！","능글맞고 여유로운 말투":"まあ、ちょっと聞いて","냉소적인 말투":"一応、伝えておく","걸걸한 아저씨 말투":"おい、ちょっと聞け","거칠고 상스러운 말투":"おい、聞いてくれ","중2병 말투":"封印の彼方からの伝言","인터넷소설 감성체":"急にキミを思い出したょ…","하드보일드 누아르체":"街に残された短い伝言","고풍스러운 말투":"そなたへ送る言葉","사극 선비 말투":"そなたに尋ねたいことがある","군인식 말투":"連絡事項報告","마왕의 말투":"人の子への勅命","군주의 말투":"王よりの言葉","신탁을 내리는 신의 말투":"今日の神託","옛날 번역기체":"連絡のメッセージが到着しました","귀엽고 애교 있는 말투":"ちょっと来てほしいな～","수다스럽고 말이 많은 말투":"急ぎじゃないけど少し話したくて"
  }
};
...
export function characterContactTitle(character,base,{language="ko"}={}){
  ...
  if(!text)return text;
  if(style==="장난스러운 게임 채팅체")return language==="en"?"hey, quick ping":language==="ja"?"ねえ、ちょい聞いて":"야 잠깐 ㅋㅋ";
...
function rawCharacterContactSpeech(character,base,{language="ko"}={}){
  ...
  if(!text)return text;
  if(style==="장난스러운 게임 채팅체")return language==="en"?`${text.replace(/Would you like to/gi,"wanna").replace(/\byou\b/gi,"u").replace(/I am/g,"I’m")} let’s go`:language==="ja"?`${text.replace(/しましょう/g,"しよ").replace(/です。/g,"だよ。")} とりま一緒に考えよ。`:`${koreanCasual(text)} 일단 같이 생각해 보자 ㄱㄱ`;
  ...
  const wrappers={
    ...
    "스타트업 업무체":value=>`가볍게 체크인드려요. 아래 내용으로 얼라인 부탁드려요. ${value}`,
    ...
    "거칠고 상스러운 말투":value=>`@#$%, 복잡하게 굴 것 없이 들어 봐. ${koreanCasual(value)}`,
    "중2병 말투":value=>`봉인의 틈에서 전언이 도착했다… ${koreanPlain(value)}`,
    "인터넷소설 감성체":value=>`있자나… 갑자기 니 생각나서 연락했오 ㅠ_ㅠ ${koreanCasual(value)}`,
...
function rawCharacterPlanSpeech(character,language="ko"){
  ...
  if(style==="스타트업 업무체")return language==="en"?"Priorities aligned. I’ll work through the action items in this order.":language==="ja"?"優先順位をすり合わせました。この順番で進めます。":"우선순위 얼라인됐어요. 이 순서로 액션 아이템 진행할게요.";
  if(style==="장난스러운 게임 채팅체")return language==="en"?"plan locked in. one task at a time, let’s go":language==="ja"?"予定決まった。一個ずついこw":"계획 정했음. 하나씩 끝내 보자 ㄱㄱ";
...
export function canonicalSpeechStyle(value){
 ...
 return ({'거칠고 상스러운 말투 · 순화':'거칠고 상스러운 말투','상냥하고 배려하는 말투':'다정하고 부드러운 말투'})[value]||value;
}
...
export function speechStyleExample(character,options={}){
 ...
 '거칠고 상스러운 말투':["Enough messing around. Just pick a @#$% plan.",'@#$%、さっさと決めちまおうぜ。'],
 '인터넷소설 감성체':["weekend plan?? i cant choooose T_T",'週末どぉするぅ…？ 選べなぃよぉ T_T'],
