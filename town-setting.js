import {townBackgroundFields,backgroundSettings,townBackground} from './town-background.js';
...
export function normalizeTownSetting(town={}){if(town.backgroundSetting)return backgroundSettings(townBackground(town),town.backgroundRulesEnabled!==false);return {era:Object.hasOwn(TOWN_ERAS,town.era)?town.era:'modern',culture:Object.hasOwn(TOWN_CULTURES,town.culture)?town.culture:'mixed'}}
