import {townBackgroundFields} from './town-background.js';
...
export function normalizeTownSetting(town={}){if(town.backgroundSetting)return {backgroundSetting:town.backgroundSetting==='arkenwald'?'arkenwald':'drawer',era:town.backgroundSetting==='arkenwald'?'medieval':'modern',culture:town.backgroundSetting==='arkenwald'?'europe':'mixed'};return {era:Object.hasOwn(TOWN_ERAS,town.era)?town.era:'modern',culture:Object.hasOwn(TOWN_CULTURES,town.culture)?town.culture:'mixed'}}
...
export const townSettingFields=townBackgroundFields;
