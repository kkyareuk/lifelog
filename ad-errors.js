...
export function adErrorText(error,language=document.documentElement.lang){
 ...
 if(stage==='banner'&&code==='3')return t('지금은 제공할 광고가 없어요. 잠시 후 자동으로 다시 확인해요. (3)','No ad is available right now. We’ll retry shortly. (3)','現在配信できる広告がありません。しばらくしてから自動で再確認します。(3)');
