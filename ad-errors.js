...
export function adErrorText(error,language=document.documentElement.lang,platform=globalThis.window?.Capacitor?.getPlatform?.()){
 ...
 if(stage==='banner'&&(platform==='ios'?code==='1':code==='3'))return t('지금은 제공할 광고가 없어요. 잠시 후 자동으로 다시 확인해요.','No ad is available right now. We’ll retry shortly.','現在配信できる広告がありません。しばらくしてから自動で再確認します。');
