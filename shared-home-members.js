...
export function bindSharedHomeMembers(root,s,world,canEdit,render,toast){
 ...
 function editor(kind,id){
  ...
  if(kind==='resident'){
   ...
   field('sleepElsewhere',mt('가끔 다른 곳에서 자기','Sometimes sleep elsewhere','時々ほかの場所で寝る'),null,'checkbox');
   field('sleepElsewhereFrequency',mt('다른 곳에서 자는 빈도','Frequency','頻度'),[['rare',mt('드물게 · 5%','Rarely · 5%','まれに · 5%')],['sometimes',mt('가끔 · 15%','Sometimes · 15%','時々 · 15%')],['often',mt('자주 · 35%','Often · 35%','よく · 35%')],['frequent',mt('빈번함 · 50%','Frequently · 50%','頻繁 · 50%')],['high',mt('높은 편 · 70%','High · 70%','高め · 70%')],['mostly',mt('거의 뒤바뀜 · 85%','Mostly elsewhere · 85%','ほとんど別の場所 · 85%')],['almostAlways',mt('거의 항상 다른 곳 · 95%','Almost always elsewhere · 95%','ほぼ常に別の場所 · 95%')]]);
