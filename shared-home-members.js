...
export function bindSharedHomeMembers(root,s,world,canEdit,render,toast){
 ...
 function editor(kind,id){
  ...
  if(kind==='resident'){
   ...
   field('sleepElsewhereFrequency',mt('다른 곳에서 자는 빈도','Frequency','頻度'),[['rare',mt('드물게 · 5%','Rarely · 5%','まれに · 5%')],['sometimes',mt('가끔 · 15%','Sometimes · 15%','時々 · 15%')],['often',mt('자주 · 35%','Often · 35%','よく · 35%')]]);
