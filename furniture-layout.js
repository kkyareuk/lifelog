...
export const FURNITURE_PROPS=Object.freeze(["책","화분","향수","액자","컵","인형","수집품","조명","화분 2","인덕션"]);
...
export const FURNITURE_FOOTPRINTS=Object.freeze({
  ...
  "냉장고":footprint(1,2),"카운터":footprint(1,2),"카운터 연결형":footprint(1,2),"카운터 상판":footprint(1,1),"인덕션":footprint(1,1),"화분 2":footprint(1,2),"조리대":footprint(3,1),"식탁":footprint(3,2),"오븐":footprint(1,2),"커피머신":footprint(1,1),"식기세척기":footprint(1,2),"에스프레소 머신":footprint(1,1),"티 세트":footprint(1,1),"제빵 도구":footprint(2,1),"칵테일 바":footprint(2,2),"와인 냉장고":footprint(1,2),"향신료 선반":footprint(2,1),"요리책 선반":footprint(2,2),
...
export const FURNITURE_CATALOG=Object.freeze({
  ...
  kitchen:["냉장고","카운터","카운터 연결형","카운터 상판","인덕션","조리대","식탁","오븐","커피머신","식기세척기","에스프레소 머신","티 세트","제빵 도구","칵테일 바","와인 냉장고","향신료 선반","요리책 선반"],
...
Object.assign(LABELS.en,{"카운터 연결형":"Counter extension","카운터 상판":"Countertop","화분 2":"Potted flowers","카운터":"Counter","인덕션":"Induction cooktop","커플 침대":"Couple bed","운동 장비":"Exercise gear"});
