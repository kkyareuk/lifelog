...
const copies={
 ko:{title:'서랍마을 첫걸음',next:'확인',skip:'건너뛰기',cancel:'계속하기',confirm:'안내를 건너뛸까요? 설정 > 도움말에서 다시 시작할 수 있어요.',create:'이름만 정하면 시작할 수 있어요. 사진과 나머지 설정은 나중에 채워도 괜찮아요.',made:'첫 주민을 만든 뒤 눌러 주세요',start:'첫 주민 만들기',steps:['현재 행동·장소·기분을 확인하세요.','할 일 정하기를 눌러 행동 메뉴를 열어 보세요.','분류를 열고 원하는 행동을 하나 골라 보세요.','질문 아이콘을 눌러 캐릭터에 대해 알아가 보세요.','고른 답이 성향에 반영됩니다. 질문은 건너뛸 수 있어요.','전체설정에서 성향을 정하고 잠글 수 있어요. 문의는 설정 → 익명 문의에서 보내세요.'],done:'시작하기'},
 en:{title:'First steps in Drawer Village',next:'Got it',skip:'Skip',cancel:'Continue',confirm:'Skip the tour? Restart it from Settings > Help.',create:'A name is enough to start. Photos and other settings can wait.',made:'Tap after creating your resident',start:'Create a resident',steps:['Check the current activity, location and mood.','Open Choose an activity to see the activity menu.','Open a category and choose an activity.','Tap the question icon to learn about your character.','Answers influence traits. You can skip questions.','Set and lock traits in Full settings. Send questions from Settings → Anonymous feedback.'],done:'Start playing'},
 ja:{title:'村でのはじめの一歩',next:'確認',skip:'スキップ',cancel:'続ける',confirm:'案内をスキップしますか？設定 > ヘルプから再開できます。',create:'名前だけで始められます。写真や他の設定は後からで大丈夫です。',made:'住民を作成したら押してください',start:'最初の住民を作る',steps:['現在の行動・場所・気分を確認しましょう。','やることを決めるボタンから行動メニューを開きましょう。','分類を開いて好きな行動を選んでみましょう。','質問アイコンを押してキャラクターを知りましょう。','答えは性格に反映されます。質問はスキップできます。','詳細設定で性格を決めて固定できます。お問い合わせは設定 → 匿名お問い合わせから。'],done:'遊び始める'}
};
