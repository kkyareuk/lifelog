import {lifeTask,lifeCopy} from './life-tasks.js?v=20260909dev302';
import {automaticConversation,hobbyChoice,ignoresOthers,dislikesPerson} from './automatic-activities.js?v=20260909dev302';
import {workTasks} from './social-activities.js?v=20260909dev302';
import {SOCIAL_ACTIVITIES,socialActivityCopy,ROMANTIC_ACTIVITIES,hasRomanticRelationship} from './social-activities.js?v=20260909dev302';
import {applyCharacterTransfers} from './character-transfers.js?v=20260909dev302';
import {planMeetingJourney,meetingScene} from './meeting-journey.js?v=20260909dev302';
...
import {hospitalPurposes} from "./creative-options.js?v=20260909dev302";
import {accountStorage as localStorage} from "./account-storage.js?v=20260909dev302";
import {stringifyLocalMediaState,preserveDevicePhotos} from "./local-media.js?v=20260909dev302";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260909dev302";
import {normalizeRoomLayout} from "./room-layout.js?v=20260909dev302";
import {FURNITURE_CATALOG,furnitureCapacity,furnitureCatalogForRoom,isBedFurniture,newFurniturePlacement,newFurnitureProp,normalizeFurniturePlacement,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260909dev302";
import {advanceHomeLifeSimulation as advanceLifeSimulation,normalizeHomeLifeSimulation} from "./home-simulation.js?v=20260909dev302";
import {defaultHomeSurfaceForRoom,normalizeHomeSurface,normalizeWallSurface} from "./home-surfaces.js?v=20260909dev302";
import {normalizeTownProfile,TOWN_ILLUSTRATIONS} from "./town-profile.js?v=20260909dev302";
import {normalizeBuildingLighting} from "./town-lighting.js?v=20260909dev302";
...
import {missingBuildings} from "./building-recovery.js?v=20260909dev302";
import {normalizeSceneImageVariants} from "./character-scene-image.js?v=20260909dev302";
