import {stringifyLocalMediaState,preserveDevicePhotos} from "./local-media.js?v=20260824characterlayerfix";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260824characterlayerfix";
import {normalizeRoomLayout} from "./room-layout.js?v=20260824characterlayerfix";
import {FURNITURE_CATALOG,furnitureCapacity,furnitureCatalogForRoom,isBedFurniture,newFurniturePlacement,newFurnitureProp,normalizeFurniturePlacement,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260824characterlayerfix";
import {advanceHomeLifeSimulation as advanceLifeSimulation,normalizeHomeLifeSimulation} from "./home-simulation.js?v=20260824characterlayerfix";
import {defaultHomeSurfaceForRoom,normalizeHomeSurface,normalizeWallSurface} from "./home-surfaces.js?v=20260824characterlayerfix";
