...
export function lifeSettingsFields(c,language='ko'){
 ...
 const options=[['fixed',tr('점수·관계 모두 고정','Freeze scores and relationships','スコア・関係をすべて固定')],['score',tr('점수만 변화 · 관계 고정','Change scores · freeze relationships','スコアのみ変化・関係は固定')],['dynamic',tr('점수·관계 모두 변화','Change scores and relationships','スコア・関係とも変化')]];
