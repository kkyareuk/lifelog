...
export function interactionSound(control,state={}){
 ...
 if(control.matches('.home-person,[data-home-occupant],[data-home-person],[data-person],[data-direct-simple-action],[data-direct-social-action]')||control.closest('.context-action-list'))return 'ui-character';
