...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260824homesync";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260824homesync";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260824homesync";
import {furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260824homesync";
...
function homeCard(id,chars){
  ...
  const editToolbar=edit?`<nav class="home-edit-toolbar" aria-label="집 편집 도구"><button type="button" data-open-home-feature="house-settings">집 설정</button><button type="button" data-open-home-feature="room-plan">방 추가·구성</button><button type="button" data-open-furniture-layout="${esc(id)}">가구 배치</button><button type="button" data-open-home-feature="residents">구성원</button><button type="button" class="primary" data-home-edit>완료</button></nav>`:"";
