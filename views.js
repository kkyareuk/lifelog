...
function shop(){
  ...
  return `<section class="panel form dlc-store shop-store"><div class="title"><div><h1>상점</h1><p>서랍마을을 더 넉넉하게 즐길 수 있는 이용권과 콘텐츠가 모이는 곳이에요.</p></div></div><article class="premium-product"><div class="premium-product-heading"><span>PREMIUM</span><div><small>서랍마을 프리미엄</small><h2>캐릭터와 사진을 제한 없이</h2></div><b>월 1,900원</b></div><div class="premium-benefits"><p>✓ 캐릭터 생성 무제한</p><p>✓ 사진 저장 용량 무제한</p><p>✓ 모든 DLC 50% 할인</p></div>${premium?`<div class="premium-current"><b>현재 프리미엄을 이용하고 있어요.</b><small>${accountEntitlements.cancelAtPeriodEnd?"해지 예약 상태예요. 이용 종료일까지 모든 혜택을 사용할 수 있어요.":"결제 관리 기능은 결제 서버 연결 후 제공됩니다."}</small></div>`:`<a class="primary premium-buy" href="./payment.html?product=premium">프리미엄 시작하기</a>`}<p class="premium-warning">해지해도 결제한 이용 기간이 끝날 때까지 혜택이 유지됩니다. 이후 일반회원 한도인 캐릭터 5명·사진 15MB가 적용되고, 초과 데이터는 30일 동안 잠금 및 백업 기간을 거친 뒤 정리됩니다.</p></article><section class="shop-coming"><h2>추가 콘텐츠</h2><p>새로운 콘텐츠를 준비하고 있어요.</p></section><div class="dlc-hidden" hidden>${dlc()}</div></section>`;
}
