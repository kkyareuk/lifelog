...
function relationship(sharedPass=false){
  ...
  return `<section class="panel form relationship-page relationship-redesign"><button type="button" data-settings-transfer="world-transfer" data-share-kind="relationships">${({ko:"공유 코드 · 마을 이전",en:"Sharing codes · Town transfer",ja:"共有コード・村の移転"}[state.uiLanguage]||"공유 코드 · 마을 이전")}</button>${characterViewEditor()}
