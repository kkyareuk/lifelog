...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260827townhome170";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260827townhome170";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260827townhome170";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260827townhome170";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260827townhome170";
...
const homeExteriorSource=home=>String(home?.exteriorImage||state.buildingShapes?.find(shape=>shape.id===home?.iconPreset)?.src||BUILDING_PRESET_SOURCES[home?.iconPreset]||BUILDING_PRESET_SOURCES["drawer-home"]);
