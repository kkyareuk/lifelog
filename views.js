import {meetingScene,createEntranceTransitions} from './meeting-journey.js?v=20260908dev281';
import {renderMailbox} from './mailbox-center.js?v=20260908dev281';
import {sharedResidentsScreen} from './shared-residents.js?v=20260908dev281';
import {bedPerspective} from './bed-perspective.js?v=20260908dev281';
import {conflictEvidence} from './scene-context.js?v=20260908dev281';
import {localizeLifeLog} from "./life-log-localization.js?v=20260908dev281";
import {MARTIAL_ARTS,MENTAL_HEALTH,CARE_MODES,TRADITIONAL_CLOTHES,HOSPITAL_DEPARTMENTS,hospitalPurposes,creativeCopy} from "./creative-options.js?v=20260908dev281";
import {withSharedWorld} from './shared-world.js?v=20260908dev281';
...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260908dev281";
import {renderDictionary,itemArt} from "./dictionary.js?v=20260908dev281";
import {PLACEMENTS,characterPlacement,orderAnimationCharacters} from "./character-placement.js?v=20260908dev281";
import {characterMood} from "./character-mood.js?v=20260908dev281";
import {createContactMailbox} from "./notification-mail.js?v=20260908dev281";
import {dictionaryCopy} from "./dictionary-copy.js?v=20260908dev281";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,homeGroups,withSimulationBatch} from "./simulation.js?v=20260908dev281";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260908dev281";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260908dev281";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260908dev281";
import {TOWN_TYPE_SUBTYPES,TOWN_TYPES,TOWN_REPUTATIONS,TOWN_FAME_LEVELS,TOWN_TERRAINS,TOWN_TRANSPORTS} from "./town-profile.js?v=20260908dev281";
import {normalizeBuildingLighting,buildingLightsOn,scheduleTownLighting} from "./town-lighting.js?v=20260908dev281";
import {accountStorage as localStorage} from "./account-storage.js?v=20260908dev281";
import {achievementRows} from "./achievements.js?v=20260908dev281";
import {homeEditorCopy,homeFurnitureDrawer,homeRoomBrowser,homeMemberMenu,homeInformationMarkup} from "./home-editor-ui.js?v=20260908dev281";
import {homeSleepAnimation} from "./home-simulation.js?v=20260908dev281";
import {WALKING_STYLE_OPTIONS,walkingGait,walkStyleClassFor} from "./walking-gaits.js?v=20260908dev281";
import {renderGroupRelations,renderGroupHomes,renderGroups} from "./groups.js?v=20260908dev281";
import {shouldRenderTabletObserveMap} from "./observe-responsive.js?v=20260908dev281";
...
const eventFor=(c,date=renderSceneDate||new Date())=>entranceTransitions.project(state,c,meetingScene(rawViewEvent(c,date),state.characterDirectives?.[c?.id],c?.id,date.getTime(),state.uiLanguage),date.getTime(),state.sharedContext?.groupId||window.ParallelCityAuth?.getInfo?.()?.user?.uid||'local');
...
function character(){
  ...
  const wardrobePane=`<section class="character-book-form-page wardrobe-book-page">
    <div class="book-form-grid">
      ...
      ${bookField("전통 의상","traditionalClothing",["설정하지 않음",...TRADITIONAL_CLOTHES],c.traditionalClothing||"설정하지 않음")}${bookField("옷을 고르는 기준","clothingPriority",["가격","편안함","실용성","상황에 맞춤","디자인","브랜드","유행","단벌신사"],c.clothingPriority||"가격")}
