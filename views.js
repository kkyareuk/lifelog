...
import {eventFor,visibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260802aa";
...
function character(){
  ...
  const videoFormats=Object.keys(VIDEO_GENRES),gameGenres=DETAIL_OPTIONS.game;
