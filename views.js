...
import {characterMood} from "./character-mood.js?v=20260901emotion190";
...
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260901emotion190";
...
function character(){
  ...
  const personalityEmotionFields=[
    ["평소 정서의 방향","emotionalBaseline",["낙천적인 편","대체로 밝은 편","현실적인 편","무덤덤한 편","걱정이 많은 편","비관적인 편"]],
