...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260904home209";
import {renderDictionary,itemArt} from "./dictionary.js?v=20260904home209";
import {PLACEMENTS,characterPlacement,orderAnimationCharacters} from "./character-placement.js?v=20260904home209";
import {characterMood} from "./character-mood.js?v=20260904home209";
import {createContactMailbox} from "./notification-mail.js?v=20260904home209";
import {dictionaryCopy} from "./dictionary-copy.js?v=20260904home209";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,homeGroups} from "./simulation.js?v=20260904home209";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260904home209";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260904home209";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260904home209";
import {TOWN_TYPE_SUBTYPES,TOWN_TYPES,TOWN_REPUTATIONS,TOWN_FAME_LEVELS,TOWN_TERRAINS,TOWN_TRANSPORTS} from "./town-profile.js?v=20260904home209";
import {normalizeBuildingLighting,buildingLightsOn,scheduleTownLighting} from "./town-lighting.js?v=20260904home209";
import {accountStorage as localStorage} from "./account-storage.js?v=20260904home209";
import {achievementRows} from "./achievements.js?v=20260904home209";
import {homeEditorCopy,homeFurnitureDrawer,homeRoomBrowser,homeMemberMenu} from "./home-editor-ui.js?v=20260904home209";
...
function homeCard(id,chars){
  ...
  return `<article class="home panel ${edit?"is-editing":""}" data-home-card="${id}">
    ...
    ${nativeHome?"":editToolbar}${homeSettings}${residentEditor}${sleepEditor}${homeRoomBrowser(h,state.uiLanguage,value=>t(value,value))}${homeMemberMenu(state.uiLanguage)}<div class="clean">청결도 · ${Math.round(h.cleanliness??100)}% <i style="width:${h.cleanliness??100}%"></i></div>
