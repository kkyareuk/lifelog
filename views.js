...
function character(){
  ...
  const fullPaneMeta=(profileBook?[["visual","사진·색상·배치"],["profile","개요"]]:[["visual","사진·색상·배치"],["profile","개요"],["body","신체"],["wardrobe","의상 취향"],["personality","성격"],["taste","취향·소지품"],["closet","추가 LD 사진"]]);
