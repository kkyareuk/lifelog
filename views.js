...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260821homeui1";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260821homeui1";
...
function fontSettings(){
  const options=[["system","기기·브라우저 기본 글꼴"],["hanbit","KCC 한빛체 · 손으로 그린 UI"],["dangam","창원단감둥근체"],["haeong","국민대학교 해옹 산스 · 부드러운 고딕"],["dohyeon","배달의민족 도현체 · 굵고 또렷함"],["corncorn","온글잎 콘콘체 · 편안한 손글씨"],["griun","그리운 심심체 · 손글씨"],["aggro","SB 어그로체 · 힘 있는 제목체"]];
