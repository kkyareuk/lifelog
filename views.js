import {state,active} from "./state.js?v=20260803aw";
import {eventFor,visibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260803aw";
...
function dlc(){return `<section class="panel form dlc-store"><div class="title"><div><h1>DLC 상점</h1><p>서랍 하나를 열 때마다 다른 시대의 하루가 시작돼요.</p></div><span class="dlc-badge">첫 팩</span></div><article class="dlc-product"><div class="dlc-product-art">🏰</div><div><small>시대 스크립트 팩</small><h2>중세의 하루</h2><p>촛불을 켜고 장부를 쓰고, 시장과 여관을 오가는 하루를 담았어요. 이 팩을 적용한 마을에서는 현대적인 물건과 이동 표현이 그 시대의 생활에 맞게 자연스럽게 바뀝니다.</p><ul><li>마을별 현대·중세 시대 설정</li><li>시장, 여관, 성채, 공방, 마구간 생활 스크립트</li><li>말·마차·도보 이동과 전령·서신 표현</li><li>중세 성채·여관·시장 건물 모양 3종</li></ul><div class="dlc-buy-row"><b>1,850원</b><a class="primary dlc-buy" href="./payment.html?product=medieval">토스로 구매하기</a></div></div></article><p class="dlc-note">실제 결제와 DLC 지급은 토스페이먼츠 상점 심사 및 결제 승인 서버 연결이 끝난 뒤 활성화됩니다.</p></section>`;}
