import {state,active} from "./state.js?v=20260802n";
import {eventFor,visibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260802n";
...
function observe(){
  const c=active(),e=eventFor(c),place=placeForEntry(e);
