...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260825characterbookfidelity";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260825characterbookfidelity";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260825characterbookfidelity";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260825characterbookfidelity";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260825characterbookfidelity";
...
function character(){
  ...
  const lowerBookmark=fullActivePane==="profile"?`<button type="button" class="character-book-v8-shape" data-character-pane="visual"><b>${t("모양","모양")}</b></button>`:"";
  const cornerInk=fullActivePane==="profile"?'<img class="character-book-v8-ink" src="./assets/home-ui/ink.png" alt="" aria-hidden="true">':"";
  const fullSave=fullActivePane==="visual"?"":`<button type="button" class="character-book-v8-save" data-save>${t("저장","저장")}</button>`;
