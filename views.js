...
function townInformationScreen(character){
  ...
  return `<aside class="town-information-screen" aria-label="${esc(t("마을 정보 편집","마을 정보 편집"))}"><img class="town-information-backdrop" src="${imageEsc(state.world.bg)}" alt="" aria-hidden="true">
