...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260906dev248";
import {renderDictionary,itemArt} from "./dictionary.js?v=20260906dev248";
import {PLACEMENTS,characterPlacement,orderAnimationCharacters} from "./character-placement.js?v=20260906dev248";
import {characterMood} from "./character-mood.js?v=20260906dev248";
import {createContactMailbox} from "./notification-mail.js?v=20260906dev248";
import {dictionaryCopy} from "./dictionary-copy.js?v=20260906dev248";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,homeGroups} from "./simulation.js?v=20260906dev248";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260906dev248";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260906dev248";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260906dev248";
import {TOWN_TYPE_SUBTYPES,TOWN_TYPES,TOWN_REPUTATIONS,TOWN_FAME_LEVELS,TOWN_TERRAINS,TOWN_TRANSPORTS} from "./town-profile.js?v=20260906dev248";
import {normalizeBuildingLighting,buildingLightsOn,scheduleTownLighting} from "./town-lighting.js?v=20260906dev248";
import {accountStorage as localStorage} from "./account-storage.js?v=20260906dev248";
import {achievementRows} from "./achievements.js?v=20260906dev248";
import {homeEditorCopy,homeFurnitureDrawer,homeRoomBrowser,homeMemberMenu,homeInformationMarkup} from "./home-editor-ui.js?v=20260906dev248";
import {homeSleepAnimation} from "./home-simulation.js?v=20260906dev248";
import {WALKING_STYLE_OPTIONS,walkingGait,walkStyleClassFor} from "./walking-gaits.js?v=20260906dev248";
import {renderGroups} from "./groups.js?v=20260906dev248";
import {shouldRenderTabletObserveMap} from "./observe-responsive.js?v=20260906dev248";
...
const GAME_HUD_LABELS={
  ko:{character:"캐릭터",catalog:"사전",relationship:"관계",routine:"일정",statistics:"통계",settings:"설정",mailbox:"우편함",home:"집",todayLog:"기록물",shop:"상점",town:"마을",groups:"그룹"},
  en:{character:"People",catalog:"Dictionary",relationship:"Bonds",routine:"Schedule",statistics:"Stats",settings:"Settings",mailbox:"Mail",home:"Home",todayLog:"Log",shop:"Shop",town:"Town",groups:"Groups"},
  ja:{character:"人物",catalog:"辞典",relationship:"関係",routine:"予定",statistics:"統計",settings:"設定",mailbox:"郵便",home:"家",todayLog:"記録",shop:"店",town:"村",groups:"グループ"}
};
...
Object.assign(UI_TEXT.en,{groups:"Groups",group:"Group"});
Object.assign(UI_TEXT.ja,{groups:"グループ",group:"グループ"});
function welcome(){
