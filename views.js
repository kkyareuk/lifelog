...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260826bodypage160";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260826bodypage160";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260826bodypage160";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260826bodypage160";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260826bodypage160";
...
function character(){
  ...
  const bodyAccessibilityPane=`<section class="character-body-svg-page character-body-accessibility-page" aria-label="${esc(c.name)} ${esc(t("건강·접근성 설정","건강·접근성 설정"))}">
    ...
    <nav class="character-book-page-controls body-controls" aria-label="${esc(t("신체 페이지 이동","신체 페이지 이동"))}"><button type="button" data-character-body-pane="appearance" aria-label="${esc(t("이전 페이지","이전 페이지"))}">◀</button><b>6</b><button type="button" data-character-pane="personality" aria-label="${esc(t("다음 페이지","다음 페이지"))}">▶</button></nav>
  </section>`;
    ...
    <section class="panel form">
      ...
      <section class="character-book-v8 ${state.characterSettingsView==="full"?"is-open":""}" ${state.characterSettingsView==="full"?"":"hidden"} data-character-full-ui-version="9" data-full-pane="${fullActivePane}" style="--character-accent:${esc(c.theme?.primary||"#176b60")};--character-accent-secondary:${esc(c.theme?.secondary||c.theme?.primary||"#176b60")}">
        <div class="character-book-v8-canvas">
          <span class="character-book-v8-stage" aria-hidden="true"><img class="character-book-v8-wood" src="./assets/character-ui/character-book-stage-v11.png" alt=""></span>
