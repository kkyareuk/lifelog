...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260823charactersvg1";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260823charactersvg1";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260823charactersvg1";
...
function character(){
  ...
  const hubActions=`<section class="character-setting-choices" aria-label="${esc(t("캐릭터 설정 방식","캐릭터 설정 방식"))}"><img class="character-setting-cloth" src="./assets/character-ui/character-cloth.png" alt=""><img class="character-setting-book" src="./assets/character-ui/book.png" alt=""><img class="character-setting-tape" src="./assets/character-ui/tape.png" alt=""><img class="character-setting-key" src="./assets/character-ui/key.png" alt=""><span class="character-favorite-preview" aria-label="${esc(t("선호 물품 미리보기","선호 물품 미리보기"))}">${favoriteSlots}</span><button type="button" class="character-setting-choice character-quick-choice" data-open-quick-character-settings><span>${t("빠른설정","빠른설정")}<small>${t("바로가기","바로가기")}</small></span></button><button type="button" class="character-setting-choice character-full-choice" data-open-full-character-settings><span>${t("전체설정","전체설정")}<small>${t("바로가기","바로가기")}</small></span></button></section>`;
  ...
  return `<div class="editor character-editor" style="--character-own:${esc(c.theme?.primary||"#176b60")};--character-secondary:${esc(c.theme?.secondary||c.theme?.primary||"#176b60")}">
    ...
    <section class="panel form">
      <section class="mobile-character-dashboard ${state.characterSettingsView==="full"?"is-hidden":""}" data-character-ui-version="6" style="--character-own:${esc(c.theme?.primary||"#176b60")};--character-secondary:${esc(c.theme?.secondary||c.theme?.primary||"#176b60")}">
        ${mobileProfileDraft}
        ${hubActions}
      </section>
