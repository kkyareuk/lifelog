import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260809e";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260809e";
...
function fontSettings(){
  const options=[["dangam","창원단감둥근체 · 기본 글꼴"],["dohyeon","배달의민족 도현체 · 굵고 또렷함"],["corncorn","온글잎 콘콘체 · 편안한 손글씨"],["haeong","국민대학교 해옹 산스 · 부드러운 고딕"],["aggro","SB 어그로체 · 힘 있는 제목체"],["system","기기 기본 글꼴"],["noto","Noto Sans KR · 단정한 고딕"]];
