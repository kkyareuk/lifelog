...
function character(){
  ...
  const hubActions=`<section class="character-setting-choices" aria-label="${esc(t("캐릭터 설정 방식","캐릭터 설정 방식"))}"><img class="character-setting-post-it" src="./assets/character-ui/post-it.png" alt=""><img class="character-setting-clip" src="./assets/character-ui/clip.png" alt=""><button type="button" class="character-setting-choice character-quick-choice" data-open-quick-character-settings><img src="./assets/character-ui/notebook.png" alt=""><span>${t("빠른 설정","빠른 설정")}<small>${t("생활에 필요한 핵심만","생활에 필요한 핵심만")}</small></span></button><button type="button" class="character-setting-choice character-full-choice" data-open-full-character-settings><img src="./assets/character-ui/book.png" alt=""><span class="character-favorite-preview" aria-label="${esc(t("선호 물품 미리보기","선호 물품 미리보기"))}">${favoriteSlots}</span><b>${t("전체 설정","전체 설정")}</b><small>${t("모든 설정 항목 보기","모든 설정 항목 보기")}</small></button></section>`;
