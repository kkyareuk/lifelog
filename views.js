...
Object.assign(UI_TEXT.en,{
  ...
  "계정·백업":"Account & backup","언어, 백업 파일, 앱 정보":"Language, backup files, and app info",
...
Object.assign(UI_TEXT.ja,{
  ...
  "계정·백업":"アカウント・バックアップ","언어, 백업 파일, 앱 정보":"言語、バックアップファイル、アプリ情報",
...
function settingsContent(){
  ...
  const body=settingsPane==="home"?`${sync}${menu}`:`<div class="settings-pane-heading"><button type="button" data-tab="settings" data-settings-pane="home" aria-label="설정 메뉴로 돌아가기">‹</button><span><small>SETTINGS</small><h2>${paneNames[settingsPane]}</h2></span></div>${paneContent[settingsPane]||menu}`;
