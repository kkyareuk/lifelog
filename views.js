import {meetingScene,createEntranceTransitions} from './meeting-journey.js?v=20260908dev279';
import {renderMailbox} from './mailbox-center.js?v=20260908dev279';
import {sharedResidentsScreen} from './shared-residents.js?v=20260908dev279';
import {bedPerspective} from './bed-perspective.js?v=20260908dev279';
import {conflictEvidence} from './scene-context.js?v=20260908dev279';
import {localizeLifeLog} from "./life-log-localization.js?v=20260908dev279";
import {MARTIAL_ARTS,MENTAL_HEALTH,CARE_MODES,TRADITIONAL_CLOTHES,HOSPITAL_DEPARTMENTS,hospitalPurposes,creativeCopy} from "./creative-options.js?v=20260908dev279";
import {withSharedWorld} from './shared-world.js?v=20260908dev279';
...
import {state,active,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260908dev279";
import {renderDictionary,itemArt} from "./dictionary.js?v=20260908dev279";
import {PLACEMENTS,characterPlacement,orderAnimationCharacters} from "./character-placement.js?v=20260908dev279";
import {characterMood} from "./character-mood.js?v=20260908dev279";
import {createContactMailbox} from "./notification-mail.js?v=20260908dev279";
import {dictionaryCopy} from "./dictionary-copy.js?v=20260908dev279";
import {eventFor as simulateEventFor,visibleTimeline as simulateVisibleTimeline,homeGroups,withSimulationBatch} from "./simulation.js?v=20260908dev279";
import {SPEECH_STYLE_OPTIONS} from "./speech-styles.js?v=20260908dev279";
import {furnitureFootprint,furnitureIcon,furnitureLabel,furniturePropIcon,normalizeFurniturePlacements,supportsFurnitureProps} from "./furniture-layout.js?v=20260908dev279";
import {homeSurfaceImage,normalizeHomeSurface,normalizeWallSurface,wallSurfaceImage} from "./home-surfaces.js?v=20260908dev279";
import {TOWN_TYPE_SUBTYPES,TOWN_TYPES,TOWN_REPUTATIONS,TOWN_FAME_LEVELS,TOWN_TERRAINS,TOWN_TRANSPORTS} from "./town-profile.js?v=20260908dev279";
import {normalizeBuildingLighting,buildingLightsOn,scheduleTownLighting} from "./town-lighting.js?v=20260908dev279";
import {accountStorage as localStorage} from "./account-storage.js?v=20260908dev279";
import {achievementRows} from "./achievements.js?v=20260908dev279";
import {homeEditorCopy,homeFurnitureDrawer,homeRoomBrowser,homeMemberMenu,homeInformationMarkup} from "./home-editor-ui.js?v=20260908dev279";
import {homeSleepAnimation} from "./home-simulation.js?v=20260908dev279";
import {WALKING_STYLE_OPTIONS,walkingGait,walkStyleClassFor} from "./walking-gaits.js?v=20260908dev279";
import {renderGroupRelations,renderGroupHomes,renderGroups} from "./groups.js?v=20260908dev279";
import {shouldRenderTabletObserveMap} from "./observe-responsive.js?v=20260908dev279";
...
function multiplayerObserve(snapshot,nativeHome){
  return withSharedWorld(snapshot,()=>{
    ...
    const c=active(),mood=c?characterMood(c,eventFor(c),state):null;
    if(mood){markup=markup.replaceAll('data-open-character-mood','data-shared-mood');markup+=`<dialog class="native-log-dialog" data-shared-mood-dialog><form method="dialog"><h2>${esc(c.name)} · ${mood.icon} ${esc(mood.label)}</h2><ul>${(mood.reasons||[]).map(r=>`<li>${esc(typeof r==='string'?r:r.label||r.text||'')}</li>`).join('')}</ul><button type="submit" value="close">${t('닫기','닫기')}</button></form></dialog>`;}
