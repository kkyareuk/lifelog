import {state,active} from "./state.js?v=20260801c";
import {eventFor,visibleTimeline,charactersAtPlace,homeGroups} from "./simulation.js?v=20260801c";
...
const SPICE_LEVELS=["안 매움","살짝 매콤","순한맛","신라면 맵기","매운맛","아주 매운맛"];
