...
function calculateEventFor(c,date){
  ...
  if(!rawCurrent.manualDirective&&/^(식사하는 중|Eating a meal|食事中)$/.test(rawCurrent.title||'')){const eating=mealObservation(c,rawCurrent.minute,state.uiLanguage);rawCurrent={...rawCurrent,...eating,baseTitle:eating.title,baseDesc:eating.desc}}
