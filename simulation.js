import {state,save,characterViewFor,explicitCharacterViewFor} from "./state.js?v=20260822charactergrouplayout1";
import {characterPlanSpeech} from "./speech-styles.js?v=20260822charactergrouplayout1";
...
const ENGINE_VERSION="20260822-schedule-companion1";
...
function sharedPlaceScene(c,current,date,sharedContext=null){
  ...
  const explicitCurrentPartner=!current.dateGroup?(configuredCompanion||namedSharedPartner(current,c)):null;
