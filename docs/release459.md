...
<ko-KR>
애정 표현 설정과 저장 반응을 보완했어요. 관찰·마을 전환 버튼을 제거했어요. 지갑과 직장을 별도 화면으로 분리하고 사전처럼 꾸몄어요. 두 메뉴의 상단 배너, 왼쪽 아이콘·이름 배치와 잔액 간격을 정리했어요. 재산·급여·소비·공동지갑과 건물 꾸미기는 내부 테스트에서 계속 이용할 수 있어요.
</ko-KR>
<en-US>
Improved affection settings and save responsiveness. Removed the observation/village switch. Wallet and Work now open separate dictionary-style screens with top-banner support. Improved left-menu icons, labels and balance spacing. Economy and building decoration remain available in internal testing.
</en-US>
<ja-JP>
