...
## 최종 재심사 접수 완료 — 2026-09-09 23:27 KST

- App Store Connect UI에서 iOS 1.0.269(32) 및 인앱 구입 3개 모두 `심사 대기 중` 확인.
- 제출 ID: b325a13b-4082-47ee-9149-977b67760a1c.
- 23:26 심사 회신 전송 완료: Apple 요청 7개 항목 영문 설명, 본편/보충 영상2개 첨부. 동일7개 항목 Notes 저장 확인.
- 본편은 App Review Information에도 첨부. 원본의 전체 시간·음성을 유지한 H264 압축본, 공개 App Preview로 게시하지 않음.
- 실제 iPad 마을 IMG_0038.png와 집 IMG_0039.png를 기존 iPad 스크린샷에 추가(총3장). 기존 iPhone4장 유지.
- 사용자 제공 심사 연락처 저장. 개인정보인 전화번호는 저장소에 기록하지 않음.
- 승인 후 자동 출시 설정 유지. 아직 승인/출시 완료가 아님.
- 운영 방침 사용자 확인: 기존 작품 캐릭터를 일괄 금지하지 않되, 정식 권리 침해 신고와 중단 요청에 대응. 팬 창작물 전체가 합법이라는 보장이 아님.
- 멤버 차단·퇴장 선택은32 이후 소스에 구현/검증, 운영 서버 배포 완료. 새 선택지는 제출32에 포함되지 않으며 후속 앱 빌드 필요.
