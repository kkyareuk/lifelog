...
creativeCopy.push(["약혼", "Engagement", "婚約"],["관계 비중", "Narrative weight", "物語での比重"],["비중 없음", "No emphasis", "比重なし"],["매우 높음", "Very high", "非常に高い"],["이 관계를 이야기에서 얼마나 비중 있게 다룰지 정해요. 좋아하는 정도가 아니며, 실제 감정은 관계 단계와 각자의 시선을 따라요.", "Choose how prominently this relationship appears in the story. This is not affection; feelings follow the stage and each perspective.", "物語でこの関係をどれほど扱うかを決めます。好意の強さではなく、感情は関係段階と各自の視線に従います。"],["파혼을 고민하는 중", "Considering ending the engagement", "婚約解消を考えている"],["계획이 어긋나는 중", "Plans are diverging", "計画がすれ違っている"],["미래를 조율하는 사이", "Coordinating their future", "将来を調整する仲"],["안정적으로 준비하는 사이", "Preparing steadily", "安定して準備する仲"],["서로를 믿고 준비하는 사이", "Preparing with mutual trust", "互いを信じて準備する仲"],["파혼 직후", "Just ended the engagement", "婚約解消直後"],["정리할 일이 남은 전 약혼자", "Former fiances with matters to settle", "整理することが残る元婚約者"],["연락이 끊긴 전 약혼자", "Former fiances out of contact", "連絡が途絶えた元婚約者"],["각자의 길을 가는 전 약혼자", "Former fiances going separate ways", "それぞれの道を歩む元婚約者"]);

creativeCopy.push(["낮음","Low","低い"],["보통","Normal","普通"],["높음","High","高い"]);
