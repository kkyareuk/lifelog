...
const PRODUCTS=new Set(["character_slot_1","character_slots_5","town_slot_1","storage_50mb","green_tea"]);
const CONSUMABLE_PRODUCTS=new Set(["character_slot_1","character_slots_5","town_slot_1","green_tea"]);
...
function nextEntitlements(current,productId,quantity){
  ...
  if(productId==="character_slot_1")next.characterSingleSlots=(Number(current?.characterSingleSlots??(current?.purchases?.includes("character_slot_1")?1:0))||0)+count;
  if(productId==="character_slots_5")next.characterSlotPacks=(Number(current?.characterSlotPacks??(current?.purchases?.includes("character_slots_5")?1:0))||0)+count;
