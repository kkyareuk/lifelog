...
assert.ok(css.includes('grid-template-rows:36px 34px 90px')&&css.includes('height:calc(188px + env(safe-area-inset-bottom))'));
...
assert.match(read('android/app/build.gradle'),/versionCode\s+212/);
