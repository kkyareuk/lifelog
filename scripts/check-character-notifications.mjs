...
const checks=[
  [state.includes("schema:30")&&state.includes("characterNotificationSettings:defaultCharacterNotificationSettings()"),"알림 설정 스키마와 기본값"],
  ...
  [gradle.includes("versionCode 173")&&gradle.includes('versionName "1.0.160"'),"관계·집·저장 버그 수정 개발 빌드 번호"],
