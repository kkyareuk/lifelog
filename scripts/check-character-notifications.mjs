...
const checks=[
  [state.includes("schema:26")&&state.includes("characterNotificationSettings:defaultCharacterNotificationSettings()"),"알림 설정 스키마와 기본값"],
  ...
  [gradle.includes("versionCode 118")&&gradle.includes('versionName "1.0.108"'),"가구 생활 개발 빌드 번호"],
