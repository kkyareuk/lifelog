...
const checks=[
  [state.includes("schema:27")&&state.includes("characterNotificationSettings:defaultCharacterNotificationSettings()"),"알림 설정 스키마와 기본값"],
  ...
  [gradle.includes("versionCode 120")&&gradle.includes('versionName "1.0.109"'),"그리드 가구 개발 빌드 번호"],
