...
const checks=[
  [state.includes("schema:20")&&state.includes("characterNotificationSettings:defaultCharacterNotificationSettings()"),"알림 설정 스키마와 기본값"],
  ...
  [gradle.includes("versionCode 50")&&gradle.includes('versionName "1.0.48"'),"내부 테스트 빌드 번호"],
