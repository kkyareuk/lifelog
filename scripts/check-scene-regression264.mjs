...
const {state,updateFurniturePlacement}=await import("../state.js?v=20260907hotfix264");
const {accountStorage}=await import("../account-storage.js?v=20260907hotfix264");
...
assert.match(gradle,/versionCode\s+264\b/);
assert.match(gradle,/versionName\s+"1\.0\.215\.10"/);
assert.match(prepare,/DRAWER_VILLAGE_NATIVE_BUILD="20260907hotfix264"/);
console.log("PASS hotfix 264 regression: furniture persistence, mailbox answers, immutable logs, and shared schedules");
