...
assert(/versionCode\s+245\b/.test(gradle),"Android versionCode must be 245");
assert(/versionName\s+"1\.0\.215\.5"/.test(gradle),"Android versionName must be 1.0.215.5");
assert(prepareApp.includes('DRAWER_VILLAGE_NATIVE_BUILD="20260906hotfix245"'),"diagnostic build tag must advance");
...
console.log("hotfix 245 Android immersive navigation checks passed");
