...
try{
 ...
 await page.screenshot({path:out+'/house443.png'});
 ...
 console.log('PASS443 house canvas dimensions, preserved layout, restored scroll, tap cycling and independent attached-object drag');
