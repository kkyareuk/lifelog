...
const purchase={transactionId:'123',productId:'com.drawervillage.app.character_slots_5',bundleId:'com.drawervillage.app',environment,type:'Consumable',quantity:1,appAccountToken:accountToken(uid)};
