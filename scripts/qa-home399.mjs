...
const {chromium,webkit}=require(playwrightPath),output=resolve(root,"tmp/qa-home399");
...
try{
 ...
 console.log('PASS399 home/drawer/plaza navigation and bounds KO EN JA at 360/412, relocated discovery, friend acceptance UI and HTML escaping');
