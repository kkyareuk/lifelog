...
assert.match(css,/\.home\.is-editing \.rooms:has\(\.room-dragging\)::before/);
...
assert.match(views,/owned=id==="storage_50mb"&&accountEntitlements\.storage50/);
assert.match(views,/data-purchase-state="\$\{owned\?"unavailable":"checking"\}"/);
