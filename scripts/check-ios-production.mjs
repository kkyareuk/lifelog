...
assert.equal(source.commit,'f3f25f6');assert.equal(source.androidCode,294);
...
assert.equal(release.sourceAndroidCode,294);assert.equal(release.sourceAndroidVersion,'1.0.261');
...
console.log('PASS production 294 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
