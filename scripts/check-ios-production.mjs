...
assert.equal(source.commit,'221f72c');assert.equal(source.androidCode,296);
...
assert.equal(release.sourceAndroidCode,296);assert.equal(release.sourceAndroidVersion,'1.0.263');
...
console.log('PASS production 296 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
