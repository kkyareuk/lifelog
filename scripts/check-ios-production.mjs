...
assert.equal(source.commit,'d151edc');assert.equal(source.androidCode,299);
...
assert.equal(release.sourceAndroidCode,299);assert.equal(release.sourceAndroidVersion,'1.0.266');
...
console.log('PASS production 299 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
