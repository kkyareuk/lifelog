...
assert.equal(source.commit,'c1a6e36');assert.equal(source.androidCode,297);
...
assert.equal(release.sourceAndroidCode,297);assert.equal(release.sourceAndroidVersion,'1.0.264');
...
console.log('PASS production 297 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
