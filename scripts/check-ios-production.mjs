...
assert.equal(source.commit,'8600fcc');assert.equal(source.androidCode,295);
...
assert.equal(release.sourceAndroidCode,295);assert.equal(release.sourceAndroidVersion,'1.0.262');
...
console.log('PASS production 295 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
