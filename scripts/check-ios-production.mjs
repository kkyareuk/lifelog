...
assert.equal(source.commit,'747de94');assert.equal(source.androidCode,293);
...
assert.equal(release.sourceAndroidCode,293);assert.equal(release.sourceAndroidVersion,'1.0.260');
...
console.log('PASS production 293 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
