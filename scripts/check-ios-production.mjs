...
assert.equal(source.commit,'5dd37f1');assert.equal(source.androidCode,301);
...
assert.equal(release.sourceAndroidCode,301);assert.equal(release.sourceAndroidVersion,'1.0.268');
...
console.log('PASS production 301 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
