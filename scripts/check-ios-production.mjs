...
assert.equal(source.commit,'10f75bf');assert.equal(source.androidCode,300);
...
assert.equal(release.sourceAndroidCode,300);assert.equal(release.sourceAndroidVersion,'1.0.267');
...
console.log('PASS production 300 game hashes, shared game parity and reviewed platform changes, explicit eligible upload without review submission');
