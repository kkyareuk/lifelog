...
try{
  ...
  const checks=await page.evaluate(async()=>{
    const game=await import('/state.js?v=20260907dev266'),transfer=await import('/settings-transfer.js?v=20260907dev266'),c=game.state.characters[game.state.activeId],home=game.state.homes[c.homeId];
  ...
  await page.evaluate(async()=>{
    ...
    (await import('/groups.js?v=20260907dev266')).showMultiplayerList();location.hash='tab=groups';
