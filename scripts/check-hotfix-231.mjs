...
assert.match(gradle,/versionCode\s+231/);
assert.match(gradle,/versionName\s+"1\.0\.204\.3"/);
assert.match(index,/app\.js\?v=20260906hotfix231/);
assert.match(app,/auth\.js\?v=20260906hotfix231/);
...
console.log("PASS 231: Android Google sign-in uses the visible legacy account chooser with immediate feedback and duplicate-tap protection");
