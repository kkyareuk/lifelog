...
const checks=[
  ...
  [/drawer-village-v2026090[12]-(?:emotion-190|statistics-191|taste-scroll-194|personality-home-195|emotion-tastes-196)/.test(sw)&&sw.includes("life-log-localization.js"),"새 캐시 및 생활 로그 번역 모듈"]
];
