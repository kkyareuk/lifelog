...
const checks=[
  ...
  [/versionCode\s+(?:19\d|20[0-4])/.test(gradle)&&/versionName\s+"1\.0\.(?:1[78]\d|190)(?:\.\d+)?"/.test(gradle),"개발 빌드 190 이상 / 1.0.17x~1.0.190"],
  [/drawer-village-v2026090[12]-(?:emotion-190|statistics-191|taste-scroll-194|personality-home-195|emotion-tastes-196|bed-buildings-197|life-assets-198|character-settings-199|bed-buildings-statistics-200|buttons-love-hotfix-201|relationship-emotion-202|language-scene-203|font-204)/.test(sw)&&sw.includes("life-log-localization.js"),"새 캐시 및 생활 로그 번역 모듈"]
];
