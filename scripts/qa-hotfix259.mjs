...
try {
 ...
 await page.evaluate(async()=>{
  window.game=await import('/state.js?v=20260907dev262');
  const dict=await import('/dictionary.js?v=20260907dev262');
 ...
 const scenes=await page.evaluate(async()=>{
  const sim=await import('/simulation.js?v=20260907dev262'),c=game.state.characters[game.state.activeId];c.createdAt=1;c.wake='00:00';c.sleep='23:50';c.days={};c.timelineResetAt=0;
