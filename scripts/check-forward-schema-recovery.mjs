...
const futureState={
  schema:27,lastSaved:270,activeTab:"observe",activeId:"c1",activeTownId:"town1",
...
console.log("PASS 이후 schema 27 데이터를 빈 게임으로 바꾸지 않습니다");
console.log("PASS 오래된 단일값 즐겨찾기·소지품을 안전한 배열로 복구합니다");

storage.clear();
storage.set("drawer-village-game-v1",JSON.stringify({schema:26,characters:{},order:[],deletedCharacterIds:[]}));
