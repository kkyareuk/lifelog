...
const futureState={
  schema:26,lastSaved:260,activeTab:"observe",activeId:"c1",activeTownId:"town1",
...
console.log("PASS 이후 schema 26 데이터를 빈 게임으로 바꾸지 않습니다");

storage.clear();
storage.set("drawer-village-game-v1",JSON.stringify({schema:25,characters:{},order:[],deletedCharacterIds:[]}));
