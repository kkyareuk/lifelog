...
const futureState={
  schema:25,lastSaved:250,activeTab:"observe",activeId:"c1",activeTownId:"town1",
  characters:{c1:{id:"c1",name:"복구할 캐릭터",createdAt:1,townId:"town1",homeId:"home1"}},order:["c1"],
...
console.log("PASS 최신 개발판 schema 25를 핫픽스에서 빈 게임으로 바꾸지 않습니다");

storage.clear();
storage.set("drawer-village-game-v1",JSON.stringify({schema:24,characters:{},order:[],deletedCharacterIds:[]}));
