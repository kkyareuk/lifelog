...
assert.match(gradle,/versionCode\s+(?:202|203)/);
assert.match(gradle,/versionName\s+"1\.0\.18[89]"/);
assert.ok(/drawer-village-v20260902-(?:relationship-emotion-202|language-scene-203)/.test(serviceWorker));
