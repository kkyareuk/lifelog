...
try{
 ...
 await member.locator('[data-court-open]').click();await member.locator('[data-court-scene]').first().waitFor();await member.locator('[data-court-back]').click();await member.locator('[data-court-open]').waitFor();
