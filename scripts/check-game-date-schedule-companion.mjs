...
const checks=[
  ...
  [gradle.includes("versionCode 182")&&gradle.includes('versionName "1.0.169"'),"관계·마을 화면 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260831restore182");
