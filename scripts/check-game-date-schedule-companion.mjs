...
const checks=[
  ...
  [gradle.includes("versionCode 119")&&gradle.includes('versionName "1.0.106.1"'),"생활 로그 불변성 핫픽스 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823logimmutablehotfix");
