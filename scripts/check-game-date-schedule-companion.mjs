...
const checks=[
  ...
  [gradle.includes("versionCode 172")&&gradle.includes('versionName "1.0.159"'),"관계 SVG 보정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260827relationship172");
