...
const checks=[
  ...
  [gradle.includes("versionCode 95")&&gradle.includes('versionName "1.0.78.4"'),"캐릭터 그룹 모바일 레이아웃 핫픽스 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822charactergrouplayout1");
