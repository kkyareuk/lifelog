...
const checks=[
  ...
  [gradle.includes("versionCode 137")&&gradle.includes('versionName "1.0.126"'),"캐릭터 전체설정 개요·기본 SVG 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824characterbooksync");
