...
const checks=[
  ...
  [gradle.includes("versionCode 112")&&gradle.includes('versionName "1.0.102"'),"캐릭터 허브 대비 교정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823charactercontrast");
