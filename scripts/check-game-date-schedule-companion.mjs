...
const checks=[
  ...
  [gradle.includes("versionCode 171")&&gradle.includes('versionName "1.0.158"'),"캐릭터 전체설정 선택창 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260827relationship171");
