...
const checks=[
  ...
  [gradle.includes("versionCode 138")&&gradle.includes('versionName "1.0.127"'),"캐릭터 전체설정 Android 레이어 수정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824characterlayerfix");
