...
const checks=[
  ...
  [gradle.includes("versionCode 139")&&gradle.includes('versionName "1.0.128"'),"마을 건물 편집·캐릭터 책 표면 수정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824townbuildingbookfallback");
