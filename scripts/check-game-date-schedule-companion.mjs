...
const checks=[
  ...
  [gradle.includes("versionCode 94")&&gradle.includes('versionName "1.0.89"'),"최신 편집본 데이터 복구 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822forwardrecovery2");
