...
const checks=[
  ...
  [gradle.includes("versionCode 127")&&gradle.includes('versionName "1.0.116"'),"TV·조깅·집 상단바 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824hometvjogmotion");
