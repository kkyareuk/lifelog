...
const checks=[
  ...
  [gradle.includes("versionCode 133")&&gradle.includes('versionName "1.0.121.1"'),"관계·사전 핫픽스 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825relationshipcataloghotfix133");
