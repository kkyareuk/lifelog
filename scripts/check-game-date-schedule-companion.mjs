...
const checks=[
  ...
  [gradle.includes("versionCode 99")&&gradle.includes('versionName "1.0.78.6"'),"빈 사용자 마을 HUD 긴급패치 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822emptytownhud1");
