...
const checks=[
  ...
  [gradle.includes("versionCode 136")&&gradle.includes('versionName "1.0.125"'),"캐릭터 전체설정·직접 배치 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824charactersvggesture");
