...
const checks=[
  ...
  [gradle.includes("versionCode 173")&&gradle.includes('versionName "1.0.160"'),"관계·집·저장 버그 수정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260828relationship173");
