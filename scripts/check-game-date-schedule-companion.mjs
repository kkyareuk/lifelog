...
const checks=[
  ...
  [gradle.includes("versionCode 178")&&gradle.includes('versionName "1.0.165"'),"관계·마을 화면 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260828town178b");
