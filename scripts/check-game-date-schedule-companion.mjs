...
const checks=[
  ...
  [gradle.includes("versionCode 103")&&gradle.includes('versionName "1.0.95"'),"최신 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823characterfidelity2");
