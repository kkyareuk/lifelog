...
const checks=[
  ...
  [gradle.includes("versionCode 124")&&gradle.includes('versionName "1.0.113"'),"집 버튼·가구 크기 보정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824homefurniture");
