...
const checks=[
  ...
  [gradle.includes("versionCode 100")&&gradle.includes('versionName "1.0.92"'),"최신 편집본 빈 사용자 마을 HUD 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822emptytownhud2");
