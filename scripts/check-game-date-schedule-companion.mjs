...
const checks=[
  ...
  [gradle.includes("versionCode 92")&&gradle.includes('versionName "1.0.88"'),"최신 편집본 일정·동행 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822schedulecompanion2");
