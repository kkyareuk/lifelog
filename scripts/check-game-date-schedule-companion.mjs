...
const checks=[
  ...
  [gradle.includes("versionCode 170")&&gradle.includes('versionName "1.0.157"'),"캐릭터 전체설정 선택창 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825characterbookmenu150");
