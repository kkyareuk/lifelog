...
const checks=[
  ...
  [gradle.includes("versionCode 129")&&gradle.includes('versionName "1.0.118"'),"집 바닥·마을 이동·상호작용 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824floortownconversation");
