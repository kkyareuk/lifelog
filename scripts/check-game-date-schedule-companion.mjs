...
const checks=[
  ...
  [gradle.includes("versionCode 115")&&gradle.includes('versionName "1.0.105"'),"캐릭터 팝업·알림 말투 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823notificationvoice");
