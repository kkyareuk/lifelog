...
const checks=[
  ...
  [gradle.includes("versionCode 128")&&gradle.includes('versionName "1.0.117"'),"집 HUD·TV·조깅·손톱 활동 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824homehudtvjognail");
