...
const checks=[
  ...
  [gradle.includes("versionCode 123")&&gradle.includes('versionName "1.0.112"'),"집 HUD 보정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824homecards");
