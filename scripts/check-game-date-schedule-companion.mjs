...
const checks=[
  ...
  [gradle.includes("versionCode 107")&&gradle.includes('versionName "1.0.78.8"'),"실제 홈 비율 LD 편집 긴급패치 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823truepreviewhotfix1");
