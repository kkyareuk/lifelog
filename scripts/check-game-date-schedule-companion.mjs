...
const checks=[
  ...
  [gradle.includes("versionCode 125")&&gradle.includes('versionName "1.0.114"'),"집 층 이동·생활 애니메이션 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824homeelevatormotion");
