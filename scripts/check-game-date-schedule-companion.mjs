...
const checks=[
  ...
  [gradle.includes("versionCode 117")&&gradle.includes('versionName "1.0.107"'),"가구 배치 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823furnitureplacement");
