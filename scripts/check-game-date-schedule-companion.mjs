...
const checks=[
  ...
  [gradle.includes("versionCode 93")&&gradle.includes('versionName "1.0.78.3"'),"배포판 데이터 복구 핫픽스 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822forwardrecovery1");
