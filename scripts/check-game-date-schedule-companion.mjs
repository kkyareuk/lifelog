...
const checks=[
  ...
  [gradle.includes("versionCode 91")&&gradle.includes('versionName "1.0.78.2"'),"배포판 핫픽스 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822schedulecompanion1");
