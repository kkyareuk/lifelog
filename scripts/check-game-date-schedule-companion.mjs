...
const checks=[
  ...
  [gradle.includes("versionCode 131")&&gradle.includes('versionName "1.0.120"'),"방 색감·관계 좌우·상호작용 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824furnituresprites");
