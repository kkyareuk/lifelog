...
const checks=[
  ...
  [css.includes(".game-hud-date")&&css.includes("top:3.487dvh")&&css.includes("font-size:12px!important")&&css.includes("top:5.45dvh")&&css.includes("-webkit-text-stroke:.85px #000!important"),"게임 날짜를 검은 외곽선의 흰색 12px로 시간 위에 우측 정렬"],
  ...
  [gradle.includes("versionCode 110")&&gradle.includes('versionName "1.0.100"'),"캐릭터 화면 레이어·상호작용 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823characterlayer2");
