...
const checks=[
  ...
  [gradle.includes("versionCode 116")&&gradle.includes('versionName "1.0.106"'),"방 배치 안정화 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823roomlayout");
