...
const checks=[
  ...
  [gradle.includes("versionCode 126")&&gradle.includes('versionName "1.0.115"'),"집 UI·생활감 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824homelivelymotion");
