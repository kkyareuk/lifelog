...
const checks=[
  ...
  [gradle.includes("versionCode 106")&&gradle.includes('versionName "1.0.97"'),"실제 홈 비율 LD 편집 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823truepreview1");
