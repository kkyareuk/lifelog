...
const checks=[
  ...
  [gradle.includes("versionCode 96")&&gradle.includes('versionName "1.0.90"'),"최신 편집본 캐릭터 그룹 레이아웃 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822charactergrouplayout2");
