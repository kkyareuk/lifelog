...
const checks=[
  ...
  [gradle.includes("versionCode 141")&&gradle.includes('versionName "1.0.130"'),"방 레이어·캐릭터 책 개요 수정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825roomlayerbookoverview");
