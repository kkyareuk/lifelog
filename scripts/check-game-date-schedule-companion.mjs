...
const checks=[
  ...
  [gradle.includes("versionCode 104")&&gradle.includes('versionName "1.0.78.7"'),"LD 배치 영역 긴급패치 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823ldstagehotfix1");
