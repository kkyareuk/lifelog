...
const checks=[
  ...
  [gradle.includes("versionCode 149")&&gradle.includes('versionName "1.0.138"'),"캐릭터 허브 격리 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825habitsaudio149");
