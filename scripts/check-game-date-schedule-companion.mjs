...
const checks=[
  ...
  [gradle.includes("versionCode 111")&&gradle.includes('versionName "1.0.101"'),"동기화·생활 로그 연속성 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823synccontinuity");
