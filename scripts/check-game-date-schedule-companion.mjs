...
const checks=[
  ...
  [gradle.includes("versionCode 143")&&gradle.includes('versionName "1.0.132"'),"캐릭터 책 전면 재작성 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825characterbookrewrite");
