...
const checks=[
  ...
  [gradle.includes("versionCode 98")&&gradle.includes('versionName "1.0.91"'),"최신 편집본 관계 화면 스크롤 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822relationshipscroll2");
