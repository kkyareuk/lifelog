...
const checks=[
  ...
  [gradle.includes("versionCode 185")&&gradle.includes('versionName "1.0.172"'),"관계·마을 화면 개선 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260831village185");
