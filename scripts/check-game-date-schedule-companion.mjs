...
const checks=[
  ...
  [gradle.includes("versionCode 161")&&gradle.includes('versionName "1.0.121.4"'),"일정 삭제 핫픽스 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260826scheduledeletionhotfix161");
