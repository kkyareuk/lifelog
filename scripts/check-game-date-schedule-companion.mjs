...
const checks=[
  ...
  [gradle.includes("versionCode 108")&&gradle.includes('versionName "1.0.98"'),"캐릭터 SVG 고증 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260823charactersvg1");
