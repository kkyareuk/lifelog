...
const checks=[
  ...
  [gradle.includes("versionCode 133")&&gradle.includes('versionName "1.0.122"'),"사용자 집 재질·벽 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260824walllogfix");
