...
const checks=[
  ...
  [gradle.includes("versionCode 142")&&gradle.includes('versionName "1.0.131"'),"캐릭터 책 구조 수정 개발 빌드 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260825characterbookrootfix");
