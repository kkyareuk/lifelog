...
const checks=[
  ...
  [gradle.includes("versionCode 97")&&gradle.includes('versionName "1.0.78.5"'),"관계 화면 스크롤 핫픽스 버전"]
];
...
const {state:runtimeState}=await import("../state.js?v=20260822relationshipscroll1");
