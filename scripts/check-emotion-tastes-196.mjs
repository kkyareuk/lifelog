...
ok(/drawer-village-v20260902-(?:emotion-tastes-196|bed-buildings-197|life-assets-198|character-settings-199|bed-buildings-statistics-200|buttons-love-hotfix-201|relationship-emotion-202)/.test(sw),"서비스워커 캐시가 새 빌드로 분리된다");
