...
ok(/versionCode\s+196/.test(gradle)&&/versionName\s+"1\.0\.183"/.test(gradle),"Android 버전은 1.0.183 / 196이다");
ok(sw.includes("drawer-village-v20260902-emotion-tastes-196"),"서비스워커 캐시가 새 빌드로 분리된다");
