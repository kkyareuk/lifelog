...
ok(/versionCode\s+(?:19[6-9]|20[0-2])/.test(gradle)&&/versionName\s+"1\.0\.18[3-8](?:\.\d+)?"/.test(gradle),"Android 버전은 1.0.183 / 196 이상이다");
ok(/drawer-village-v20260902-(?:emotion-tastes-196|bed-buildings-197|life-assets-198|character-settings-199|bed-buildings-statistics-200|buttons-love-hotfix-201|relationship-emotion-202|language-scene-203)/.test(sw),"서비스워커 캐시가 새 빌드로 분리된다");
