...
const {state,setCharacterBodyChoices,directCharacterActivity}=await import("../state.js?v=20260907dev260");
const {accountStorage}=await import("../account-storage.js?v=20260907dev260");
const {eventFor}=await import(`../simulation.js?v=20260907dev260`);
...
assert.match(views,/drawer-shop-nerine\.png\?v=20260907dev260/);
...
assert.match(prepare,/DRAWER_VILLAGE_NATIVE_BUILD="20260907dev260"/);
