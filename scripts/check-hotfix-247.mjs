...
assert.match(gradle,/versionCode\s+247\b/);
assert.match(gradle,/versionName\s+"1\.0\.215\.6"/);
assert.ok(prepare.includes('DRAWER_VILLAGE_NATIVE_BUILD="20260906hotfix247"'));
