...
await access(new URL("../assets/home-walls/drawer-cream-wall.png",import.meta.url));
await access(new URL("../artist-templates/home-v1.0.122/wall-redraw-template.png",import.meta.url));
...
if(!combined.includes('DEFAULT_WALL_IMAGE="./assets/home-walls/drawer-cream-wall.png"'))throw new Error("기본 손그림 벽 연결이 누락되었습니다.");
