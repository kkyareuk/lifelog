...
const checks=[
  ...
  [css.includes('.game-hud-profile-copy b{')&&css.includes('color:#fff!important;-webkit-text-fill-color:#fff!important;-webkit-text-stroke:1.2px #000!important')&&css.includes('.game-hud-top>time{')&&css.includes('top:6.25dvh!important')&&css.includes('-webkit-text-stroke:1.1px #000!important'),"이름·시간 흰 글자와 검은 외곽선 및 날짜 아래 정렬"],
