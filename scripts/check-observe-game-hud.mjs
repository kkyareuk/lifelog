...
const checks=[
  ...
  [css.includes('html.native-platform[data-active-tab="observe"] .game-observe-hud[data-native-hud-version="3"]')&&css.includes('object-fit:contain!important')&&css.includes('background:transparent!important')&&css.includes('--hud-side-top:13.85dvh'),"피그마 좌표를 따르고 자리표시 상자를 렌더링하지 않는 앱 반응형 HUD"],
  [css.includes('html.native-platform #app>header{display:none!important}')&&!css.includes('html.mobile-site #app>header{display:none!important}')&&interfaceCss.includes('dialog:not(.game-hud-roster-dialog)')&&themeCss.includes('dialog:not(.game-hud-roster-dialog)'),"앱에서만 웹 상단 바를 숨기고 대화상자 테마 침범 방지"],
