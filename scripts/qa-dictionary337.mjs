...
const {chromium}=require(playwrightPath),output=resolve(root,"qa-dictionary337");
...
try{
 ...
 window.DrawerVillageGroups={getSnapshot:()=>fixture,select:id=>{fixture.activeGroupId=id;window.DrawerVillageNavigation.go('catalog')},saveCatalogItem:async input=>{window.saved=input;fixture.catalog[0].items=input.remove?[]:[input.item];return {saved:true}}};window.DrawerVillageNavigation.go('catalog');
 });
