...
const {state,updateFurniturePlacement}=await import("../state.js?v=20260907dev254");
...
assert.match(gradle,/versionCode\s+254\b/);
assert.match(gradle,/versionName\s+"1\.0\.228"/);
assert.match(prepare,/DRAWER_VILLAGE_NATIVE_BUILD="20260907dev254"/);
console.log("PASS dev 253 regressions on dev 254: furniture persistence, mailbox answers, immutable logs, and shared schedules");
