...
try{
 ...
 await page.evaluate(async()=>{const g=await import('/state.js?v=20260909dev301');window.qaSnapshot.activeGroupId='';window.qaSnapshot.group=null;g.state.characterSettingsView='hub';location.hash='tab=character'});
