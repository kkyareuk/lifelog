...
try{
 ...
 await page.evaluate(async()=>{const g=await import('/state.js?v=20260908dev282');window.qaSnapshot.activeGroupId='';window.qaSnapshot.group=null;g.state.characterSettingsView='hub';location.hash='tab=character'});
