...
const checks=[
  ...
  [views.includes('data-toggle-decoration-catalog')&&views.includes('t("모든 테마 보기","모든 테마 보기")')&&views.includes('data-decoration-category')&&css.includes('.town-decoration-theme-row')&&css.includes('.town-decoration-results{display:flex'),"시안형 모든 테마·카테고리·가로 목록 편집모드 UI"],
