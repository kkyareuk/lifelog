...
const checks=[
  ...
  [css.includes('background:linear-gradient(180deg,#f2dfc73d')&&css.includes('background:linear-gradient(180deg,#f7eee3 0%,#eadbc9 100%)'),"정보 편집의 은은한 그라데이션과 미색 버튼형 입력 칸"]
];
