...
const checks=[
  ...
  [views.includes('class="town-information-screen"')&&views.includes('class="town-information-hero"')&&views.includes('data-world-town-type')&&views.includes('data-world-density')&&views.includes('data-world-urbanization')&&views.includes('data-world-reputation')&&views.includes('data-world-size')&&views.includes('data-world-terrain-climate')&&views.includes('data-town-photo')&&views.includes('data-world-description'),"마을 정보 SVG 기준의 전용 화면과 이름·유형·밀집도·도시화·평판·규모·지형·기후 편집"],
  ...
  [state.includes('townType:String(t.townType')&&state.includes('density:String(t.density')&&state.includes('size:String(t.size')&&state.includes('terrainClimate:String(t.terrainClimate')&&app.includes('[data-world-town-type]')&&app.includes('[data-world-terrain-climate]'),"추가 마을 정보 항목을 마을별 상태에 저장"]
];
