...
const game=await import('../state.js?v=20260909dev303');

const {gossipReasons,dislikesPerson,automaticConversation}=await import('../automatic-activities.js?v=20260909dev303');
const sim=await import('../simulation.js?v=20260909dev303');
