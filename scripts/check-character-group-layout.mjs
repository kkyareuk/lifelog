...
const checks=[
  ...
  [views.includes('data-view-summary-phrase')&&views.includes('--sentence-name:')&&views.includes('<mark style="--sentence-name:')&&css.includes('-webkit-text-stroke:2px #1b1310'),"캐릭터 이름은 테마색, 관계 문장은 흰색 검은 외곽선으로 분리"],
  ...
  [css.includes('--relationship-paper:#e7dcc4')&&css.includes('0 72px,72px -72px,-72px 0!important')&&css.includes('144px 144px!important'),"SVG와 같은 72px 베이지 모자이크 관계 배경"],
