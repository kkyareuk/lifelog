...
const game=await import('../state.js?v=20260908dev282');game.createCharacter();const profile=structuredClone(game.state.characters[game.state.activeId]);
