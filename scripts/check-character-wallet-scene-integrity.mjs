...
const checks=[
  ...
  [css.includes('left:83.6544px!important;top:20px!important;width:355.463px!important;height:532.364px!important')&&css.includes('rotate(7.62669deg)'),"SVG 기준 모자이크 종이 크기·위치·각도 적용"],
  [css.includes('left:17.3494px!important;top:528px!important;width:160px!important;height:243px!important')&&css.includes('rotate(8.12629deg)')&&css.includes('left:153.104px!important;top:541.724px!important;width:422px!important;height:354px!important')&&css.includes('rotate(-10.5736deg)')&&css.includes('left:132px!important;top:-64px!important;width:98px!important;height:129px!important'),"SVG 기준 빠른 설정 노트·전체 설정 책·클립의 위치·크기·각도 적용"],
  [css.includes('left:159.256px!important;top:484.144px!important')&&css.includes('rotate(-3.6706deg)')&&css.includes('left:34.7015px!important;top:729.608px!important')&&css.includes('rotate(10.6295deg)'),"SVG 기준 포스트잇 두 장의 위치·크기·각도 적용"],
  [css.includes('rotate(-15.0912deg)')&&css.includes('rotate(23.3659deg)')&&css.includes('width:16.588%!important;height:19.774%!important'),"회전한 전체 설정 책에서도 선호 물품 스티커의 SVG 화면 좌표 보존"],
