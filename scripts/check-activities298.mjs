...
const game=await import('../state.js?v=20260909dev305'),id=game.createCharacter(10),profile=structuredClone(game.state.characters[id]),home=game.state.homes[profile.homeId],before=JSON.stringify(game.state),now=Date.now();
