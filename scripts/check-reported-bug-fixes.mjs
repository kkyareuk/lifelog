...
const checks=[
  ...
  [css.includes('.relationship-viewpoint-dialog .relationship-all-fields{position:relative!important')&&css.includes('background:transparent!important')&&css.includes('.relationship-viewpoint-dialog>form{position:relative!important')&&css.includes('overflow-y:auto!important;overscroll-behavior:contain!important;-webkit-overflow-scrolling:touch!important;touch-action:pan-y!important')&&css.includes('.relationship-viewpoint-dialog .relationship-view-field select')&&css.includes('color-scheme:light!important'),"시선 설정 흰 판을 제거하고 선택상자를 밝게 유지하며 마지막 충동 단계까지 스크롤할 수 있다"],
