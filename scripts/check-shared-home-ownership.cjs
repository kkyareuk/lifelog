...
await service.saveHomeLayout('member',{groupId:'g',id:'own',revision:0,layout:{image:'https://example.invalid/home.png',rooms:{living:{name:'Living',accessCharacterIds:['a'],wallMaterial:'cream-plain',furniturePlacements:[]}},deletedRoomKeys:['bed']}});
