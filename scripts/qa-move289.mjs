...
try{
 ...
 await page.evaluate(async()=>{
  ...
  const g=await import('/state.js?v=20260909dev305'),w=await import('/shared-world.js?v=20260909dev305'),v=await import('/shared-residents.js?v=20260909dev305'),ui=await import('/shared-ui.js?v=20260909dev305');
