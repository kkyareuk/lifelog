...
const game=await import('../state.js?v=20260909dev302'),sim=await import('../simulation.js?v=20260909dev302');
const {drinkExperience,drinkLogCopy}=await import('../drink-log.js?v=20260909dev302');
const {localizeLifeLog}=await import('../life-log-localization.js?v=20260909dev302');
