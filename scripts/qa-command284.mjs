...
const game=await import('../state.js?v=20260909dev284');game.createCharacter();const profile=structuredClone(game.state.characters[game.state.activeId]);
