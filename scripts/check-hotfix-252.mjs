...
const {state,updateFurniturePlacement}=await import("../state.js?v=20260907hotfix252");
const {accountStorage}=await import("../account-storage.js?v=20260907hotfix252");
...
assert.match(gradle,/versionCode\s+252\b/);
assert.match(gradle,/versionName\s+"1\.0\.215\.7"/);
assert.match(prepare,/DRAWER_VILLAGE_NATIVE_BUILD="20260907hotfix252"/);
console.log("PASS hotfix 252: furniture persistence, mailbox answers, immutable logs, and shared schedules");
