...
await page.locator('[data-mail-folder="inbox"]').click();assert.equal(await page.locator('[data-select-mail]').count(),0);await page.screenshot({path:resolve(output,'mail350-normal.png')});await page.locator('[data-mail-selection-start]').click();await page.screenshot({path:resolve(output,'mail350-selection.png')});await page.locator('[data-mail-selection-cancel]').click();assert.equal(await page.locator('[data-select-mail]').count(),0);await page.locator('[data-mail-selection-start]').click();assert.equal(await page.locator('[data-select-mail]').count(),1);await page.locator('[data-select-mail]').check();page.on('dialog',d=>d.accept());await page.locator('[data-mail-delete]').click();await page.waitForFunction(()=>deleted.length===1);assert.equal(await page.locator('[data-mail-open="old"]').count(),0);await page.locator('[data-mail-folder="notices"]').click();assert.equal(await page.locator('[data-mail-open="notice"]').count(),1);
