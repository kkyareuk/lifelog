...
const {state,updateFurniturePlacement}=await import("../state.js?v=20260907hotfix259");
const {accountStorage}=await import("../account-storage.js?v=20260907hotfix259");
...
assert.match(prepare,/DRAWER_VILLAGE_NATIVE_BUILD="20260907hotfix259"/);
