...
const locked={...c,discovery:{lockRevision:333,locks:Object.fromEntries(DISCOVERY_FIELDS.map(f=>[f,true]))}};assert.equal(discoveryCandidates(locked,{title:'질문받기'}).length,0);
...
assert.equal(discoveryAnswer({...c,discovery:{lockRevision:333,locks:{interests:true}}},q('profile-interest-display'),0),null);
