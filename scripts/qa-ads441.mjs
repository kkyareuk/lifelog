...
try{
 ...
 await page.locator('.game-ad-slot button').click();
 ...
 await page.screenshot({path:out+'/ads441-landscape.png'});
 await page.setViewportSize({width:384,height:832});await page.waitForTimeout(500);
 ...
 console.log('PASS441 mock native SDK: adaptive width, retained failure slot, retry and tablet landscape;: banner reserved area, no duplicate load, dialog hide/restore, one interstitial per game');
