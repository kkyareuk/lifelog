...
assert(views.includes("character-book-stage-v13.png"),"책은 좌우가 잘리지 않은 SVG 추출 배경을 사용해야 합니다.");
...
assert(characterBookCss.includes('.personality-detail-actions{position:absolute!important')&&characterBookCss.includes('top:67cqw!important'),"성격 상세의 큰 선택 버튼은 책 안쪽 고정 영역에 있어야 합니다.");
