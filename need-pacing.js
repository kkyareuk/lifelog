...
export function needDuration(c,key){const seconds={toilet:10,hunger:90,hygiene:60,social:120,sleep:600}[key]||60;return seconds*1000*(key==='toilet'?1:clamp(c.needSettings?.duration,.5,2,1))}
