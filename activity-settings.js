...
import {state,save,updateCharacter,characterEditorActive} from './state.js?v=20260909dev305';
...
document.addEventListener('click',e=>{
 ...
 const current=()=>groupId?(characterEditorActive()&&state.sharedContext?.groupId===groupId?state.characters[id]:sharedDiscoveryCharacter(groupId,id)):state.characters[id],c=current();if(!c)return;
