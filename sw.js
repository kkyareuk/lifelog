const CACHE_VERSION="drawer-village-v20260909-dev-283";
const CORE=[
  './shared-residents.js?v=20260909dev283',
  './bed-perspective.js?v=20260909dev283',
  './scene-context.js?v=20260909dev283',
  './user-profile.js?v=20260909dev283',
