const CACHE='parallel-city-clean-v1';const FILES=['./','./index.html','./app.css','./app.js','./login.html','./manifest.webmanifest','./world-assets/cozy-town.png','./world-assets/downtown-town.png'];
