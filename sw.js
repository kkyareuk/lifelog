const CACHE_VERSION="drawer-village-v20260908-dev-282";
const CORE=[
  './shared-residents.js?v=20260908dev282',
  './bed-perspective.js?v=20260908dev282',
  './scene-context.js?v=20260908dev282',
  './user-profile.js?v=20260908dev282',
